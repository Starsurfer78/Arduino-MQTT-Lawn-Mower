...
void Print_GYRO_Reading() {
         DPRINT(" | tmp = ");    DPRINT(Temp/340.00+36.53);
         DPRINT(" | Gyro X = "); DPRINT(convert_int16_to_str(GyX));
         DPRINT(" | Gyro Y = "); DPRINT(convert_int16_to_str(GyY));
         DPRINT(" | Gyro Z = "); DPRINTLN(convert_int16_to_str(GyZ));
         delay(100);
         }
