...
void Activate_Menu_Option_Testing() {
  ...
  if (Menu_Mode_Selection == 1) {
    ...
    lcd.setCursor(0, 1);
    lcd.print("Activated");
    DPRINTLN(F("Perimeter Wire Test Started"));
    delay(5000);
    lcd.clear();
    Menu_Mode_Selection = 0;
    lcd.clear();
  ...
  if (Menu_Mode_Selection == 7) {
    ...
    DPRINTLN(F("Volts and Amps Test"));
    Menu_Mode_Selection = 0;
    delay(1000);
    lcd.clear();
    Menu_Complete = false;
  ...
  if (Menu_Mode_Selection == 8) {
    ...
    DPRINTLN(F("Compass Test Selected"));
    Menu_Mode_Selection = 0;
    delay(3000);
    lcd.clear();
    lcd.setCursor(0, 0);
  ...
  if (Menu_Mode_Selection == 9) {
    ...
    DPRINTLN(F("Test Compass Turn to Home Test and Follow Wire"));
    Menu_Mode_Selection = 0;
    delay(3000);
    lcd.clear();
