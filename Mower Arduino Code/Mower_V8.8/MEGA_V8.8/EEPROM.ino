...
void Load_EEPROM_Saved_Data() {
  ...
  if (Alarm_1_Saved_EEPROM == 1) {
    ...
    DPRINT(F("Alarm 1 time from EEPROM "));
    DPRINT(Alarm_1_Hour);
    DPRINT(F(":"));
    if (Alarm_1_Minute < 10) DPRINT("0");
    DPRINTLN(Alarm_1_Minute);
    DPRINT("Alarm Action 1 =");
    if (Alarm_1_ON == 0) DPRINTLN(" | Alarm 1 OFF");
    if (Alarm_1_ON == 1) DPRINTLN(" | Alarm 1 Active");
    if (Alarm_1_Action == 1) DPRINTLN("Exit Zone 1");
    if (Alarm_1_Action == 2) DPRINTLN("Exit Zone 2");
    if (Alarm_1_Action == 3) DPRINTLN("Mow the Line");
    if (Alarm_1_Action == 4) DPRINTLN("Quick Start");
    if (Alarm_1_Action == 5) DPRINTLN("Custom");
  }
  ...
  if (Alarm_2_Saved_EEPROM == 1) {
    ...
    DPRINT(F("Alarm 2 time from EEPROM "));
    DPRINT(Alarm_2_Hour);
    DPRINT(F(":"));
    if (Alarm_2_Minute < 10) DPRINT("0");
    DPRINT(Alarm_2_Minute);
    if (Alarm_2_ON == 0) DPRINTLN(" | Alarm 2 OFF");
    if (Alarm_2_ON == 1) DPRINTLN(" | Alarm 2 Active");
    if (Alarm_2_Action == 1) DPRINTLN("Exit Zone 1");
    if (Alarm_2_Action == 2) DPRINTLN("Exit Zone 2");
    if (Alarm_2_Action == 3) DPRINTLN("Mow the Line");
    if (Alarm_2_Action == 4) DPRINTLN("Quick Start");
    if (Alarm_2_Action == 5) DPRINTLN("Custom");
  }
  ...
  if (Alarm_3_Saved_EEPROM == 1) {
    ...
    DPRINT(F("Alarm 3 time from EEPROM "));
    DPRINT(Alarm_3_Hour);
    DPRINT(F(":"));
    if (Alarm_3_Minute < 10) DPRINT("0");
    DPRINT(Alarm_3_Minute);
    if (Alarm_3_ON == 0) DPRINTLN(" | Alarm 3 OFF");
    if (Alarm_3_ON == 1) DPRINTLN(" | Alarm 3 Active");
    if (Alarm_3_Action == 1) DPRINTLN("Exit Zone 1");
    if (Alarm_3_Action == 2) DPRINTLN("Exit Zone 2");
    if (Alarm_3_Action == 3) DPRINTLN("Mow the Line");
    if (Alarm_3_Action == 4) DPRINTLN("Quick Start");
    if (Alarm_3_Action == 5) DPRINTLN("Custom");
  }
  ...
  if (PWM_LEFT_EEPROM == 1) {
    ...
    DPRINT(F("PWM Wheel Left value from EEPROM : "));
  ...
  if (PWM_RIGHT_EEPROM == 1) {
    ...
    DPRINT(F("PWM Wheel Right value from EEPROM : "));
  ...
  if (PWM_LEFT_Slow_EEPROM == 1) {
    ...
    DPRINT(F("PWM Wheel Wire Left value from EEPROM : "));
  ...
  if (PWM_RIGHT_Slow_EEPROM == 1) {
    ...
    DPRINT(F("PWM Wheel Wire Right value from EEPROM : "));
  ...
  if (Slow_Speed_MAG_EEPROM == 1) {
    ...
    DPRINT(F("Slow Speed MAG from EEPROM : "));
  ...
  if (PWM_BLADE_EEPROM == 1) {
    ...
    DPRINT(F("PWM Blade value from EEPROM : "));
  ...
  if (COMPASS_EEPROM == 1) {
    ...
    DPRINT(F("Compass Activated from EEPROM : "));
    if (Compass_Activate == 0) DPRINTLN(F("OFF"));
    if (Compass_Activate == 1) DPRINTLN(F("ON"));
  }

  int COMPASS_Setup_Mode_EEPROM = EEPROM.read(113);
  if (COMPASS_Setup_Mode_EEPROM == 1) {
    Compass_Setup_Mode = EEPROM.read(114);
    DPRINT(F("Compass Setup Mode from EEPROM : "));
    if (Compass_Setup_Mode == 1) DPRINTLN(F("Setup DFRobot_QMC5883 Compass"));
    if (Compass_Setup_Mode == 2) DPRINTLN(F("Setup QMC5883_Manual Compass"));
    if (Compass_Setup_Mode == 3) DPRINTLN(F("Setup QMC5883L Compass"));
  }
  ...
  if (Compass_Heading_Hold_Enabled_EEPROM == 1) {
    ...
    DPRINT(F("Compass HEading Hold Settings from EEPROM : "));
    if (Compass_Heading_Hold_Enabled == 0) DPRINTLN(F("OFF"));
    if (Compass_Heading_Hold_Enabled == 1) DPRINTLN(F("ON"));
  }
  ...
  if (CPower_EEPROM == 1) {
    ...
    CPower = CPower / 10;
    DPRINT(F("Compass Power from EEPROM : "));
    DPRINTLN(CPower);
  }
  ...
  if (Tracking_PID_P_EEPROM == 1) {
    P = EEPROM.read(22);
    P = P / 100;
    DPRINT(F("Traking PID P Setting from EEPROM : "));
    DPRINTLN(P);
  }
  ...
  if (Pattern_Mow_EEPROM == 1) {
    ...
    DPRINT(F("Pattern Mow settings from EEPROM : "));
    if (Pattern_Mow == 0) DPRINTLN(F("OFF"));
    if (Pattern_Mow == 1) DPRINTLN(F("ON Parallel"));
    if (Pattern_Mow == 3) DPRINTLN(F("ON Spiral"));
  }
  ...
  if (Minimum_Volt_EEPROM == 1) {
    ...
    DPRINT(F("Minimum Battery Voltage set from EEPROM : "));
  ...
  if (Angle_Sensor_Enabled_EEPROM == 1) {
    ...
    DPRINT(F("Angle Sensor Enabled from EEPROM : "));
    if (Angle_Sensor_Enabled == 0) DPRINTLN(F("OFF"));
    if (Angle_Sensor_Enabled == 1) DPRINTLN(F("ON"));
  }
  ...
  if (Tip_Over_Sensor_Enabled_EEPROM == 1) {
    ...
    DPRINT(F("Tip Sensor Enabled from EEPROM :  "));
    if (Tip_Over_Sensor_Enabled == 0) DPRINTLN(F("OFF"));
    if (Tip_Over_Sensor_Enabled == 1) DPRINTLN(F("ON"));
  }
  ...
  if (Mower_Turn_Delay_Min_EEPROM == 1) {
    ...
    DPRINT(F("Mower Turn Delay Min From EEPROM : "));
  ...
  if (Mower_Turn_Delay_Max_EEPROM == 1) {
    ...
    DPRINT(F("Mower Turn Delay Max From EEPROM : "));
  ...
  if (Mower_Reverse_Delay_EEPROM == 1) {
    ...
    DPRINT(F("Mower Reverse Time Delay/ms: "));
  ...
  if (Track_Wire_Zone_1_Cycles_EEPROM == 1) {
    ...
    DPRINT(F("Zone 1 Tracking Cycles "));
  ...
  if (Track_Wire_Zone_2_Cycles_EEPROM == 1) {
    ...
    DPRINT(F("Zone 2 Tracking Cycles "));
  ...
  if (Use_Charging_Station_EEPROM == 1) {
    ...
    DPRINT(F("Charge Station from EEPROM : "));
    if (Use_Charging_Station == 0) DPRINTLN(F("OFF"));
    if (Use_Charging_Station == 1) DPRINTLN(F("ON"));
  }
  ...
  if (CW_Tracking_To_Charge_EEPROM == 1) {
    ...
    DPRINT(F("Tracking Direction to Charge : "));
    if (CW_Tracking_To_Charge == 1) DPRINTLN(F("CW"));
    if (CW_Tracking_To_Charge == 0) DPRINTLN(F("OFF"));
  }
  ...
  if (CCW_Tracking_To_Charge_EEPROM == 1) {
    ...
    DPRINT(F("Tracking Direction to Charge : "));
    if (CCW_Tracking_To_Charge == 1) DPRINTLN(F("CCW"));
    if (CCW_Tracking_To_Charge == 0) DPRINTLN(F("OFF"));
  }

  int CW_Tracking_To_Start_EEPROM = EEPROM.read(53);
  if (CW_Tracking_To_Start_EEPROM == 1) {
    CW_Tracking_To_Start = EEPROM.read(54);
    DPRINT(F("Tracking Direction to Start : "));
    if (CW_Tracking_To_Start == 1) DPRINTLN(F("CW"));
    if (CW_Tracking_To_Start == 0) DPRINTLN(F("OFF"));
  }
  ...
  if (CCW_Tracking_To_Start_EEPROM == 1) {
    ...
    DPRINT(F("Tracking Direction to Start : "));
    if (CCW_Tracking_To_Start == 1) DPRINTLN(F("CCW"));
    if (CCW_Tracking_To_Start == 0) DPRINTLN(F("OFF"));
  }
  ...
  if (Max_Cycles_Straight_EEPROM == 1) {
    ...
    DPRINT(F("Straight Line Cycles before turn: "));
  ...
  if (Max_Sonar_Hit_EEPROM == 1) {
    ...
    DPRINT(F("Sonar Sensitivoty from EEPROM : "));
  ...
  if (maxdistancesonar_EEPROM == 1) {
    ...
    DPRINT(F("Sonar Activation Distance from EEPROM : "));
  ...
  if (Perimeter_Wire_Enabled_EEPROM == 1) {
    ...
    DPRINT(F("Wire Module ON/OFF from EEPROM : "));
    if (Perimeter_Wire_Enabled == 0) DPRINTLN(F("OFF"));
    if (Perimeter_Wire_Enabled == 1) DPRINTLN(F("ON"));
  }
  ...
  if (Max_Cycle_Wire_Find_EEPROM == 1) {
    ...
    DPRINT(F("Track Cycles Forwards to find Wire "));
  ...
  if (Max_Cycle_Wire_Find_Back_EEPROM == 1) {
    ...
    DPRINT(F("Track Cycles Back to find Wire "));
  ...
  if (Max_Tracking_Turn_Right_EEPROM == 1) {
    ...
    DPRINT(F("Wheel RH Cycles before restart "));
  ...
  if (Max_Tracking_Turn_Left_EEPROM == 1) {
    ...
    DPRINT(F("Wheel LH Cycles before restart "));
  ...
  if (Rain_Sensor_Installed_EEPROM == 1) {
    ...
    DPRINT(F("Rain Sensor ON/OFF from EEPROM : "));
    if (Rain_Sensor_Installed == 0) DPRINTLN(F("OFF"));
    if (Rain_Sensor_Installed == 1) DPRINTLN(F("ON"));
  }
  ...
  if (Rain_Total_Hits_Go_Home_EEPROM == 1) {
    ...
    DPRINT(F("Rain Sensitivoty from EEPROM : "));
  ...
  if (WIFI_Enabled_EEPROM == 1) {
    ...
    DPRINT(F("WIFI Enabled from EEPROM : "));
    if (WIFI_Enabled == 0) DPRINTLN(F("OFF"));
    if (WIFI_Enabled == 1) DPRINTLN(F("ON"));
  }
  ...
  if (Cutting_Blades_Activate_EEPROM == 1) {
    ...
    DPRINT(F("CUTTING BLADES SET TO : "));
    if (Cutting_Blades_Activate == 0) DPRINTLN(F("OFF"));
    if (Cutting_Blades_Activate == 1) DPRINTLN(F("ON"));
  }
  ...
  if (Low_Battery_Instances_Chg_EEPROM == 1) {
    ...
    DPRINT(F("Battery to Charge Sensitivoty from EEPROM : "));
  ...
  if (Bumper_Activate_Frnt_EEPROM == 1) {
    ...
    DPRINT(F("Bumper Bar Enabled from EEPROM : "));
    if (Bumper_Activate_Frnt == 0) DPRINTLN(F("OFF"));
    if (Bumper_Activate_Frnt == 1) DPRINTLN(F("ON"));
  }
  ...
  if (Turn_90_Delay_LH_EEPROM == 1) {
    ...
    DPRINT(F("Turn_90_Delay_LH Enabled from EEPROM : "));
  ...
  if (Turn_90_Delay_RH_EEPROM == 1) {
    ...
    DPRINT(F("Turn_90_Delay_RH Enabled from EEPROM : "));
  ...
  if (Line_Length_Cycles_EEPROM == 1) {
    ...
    DPRINT(F("Line_Length_Cycles Enabled from EEPROM : "));
  ...
  if (GPS_Enabled_EEPROM == 1) {
    ...
    DPRINT(F("GPS Enabled from EEPROM : "));
    if (GPS_Enabled == 0) DPRINTLN(F("Disabled"));
    if (GPS_Enabled == 1) DPRINTLN(F("Enabled"));
  }

  int GYRO_Enabled_EEPROM = EEPROM.read(109);
  if (GYRO_Enabled_EEPROM == 1) {
    GYRO_Enabled = EEPROM.read(110);
    DPRINT(F("GYRO Enabled from EEPROM : "));
    if (GYRO_Enabled == 0) DPRINTLN(F("Disabled"));
    if (GYRO_Enabled == 1) DPRINTLN(F("Enabled"));
  }
  ...
  if (GPower_EEPROM == 1) {
    ...
    GPower = GPower / 10;
    DPRINT(F("GYRO PID set from EEPROM : "));
    DPRINTLN(GPower);
  }
  ...
  if (Wheel_Amp_Sensor_ON_Enabled_EEPROM == 1) {
    ...
    DPRINT(F("Wheel Block Amp Sensor Enabled from EEPROM : "));
    if (Wheel_Amp_Sensor_ON == 0) DPRINTLN(F("Disabled"));
    if (Wheel_Amp_Sensor_ON == 1) DPRINTLN(F("Enabled"));
  }
  ...
  if (Max_Wheel_Amps_EEPROM == 1) {
    ...
    DPRINT(F("Wheel Block Amps set from EEPROM : "));
    DPRINTLN(Max_Wheel_Amps);
  }

  int PCB_EEPROM = EEPROM.read(119);
  if (PCB_EEPROM == 1) {
    PCB = EEPROM.read(120);
    DPRINT(F("PCB Enabled from EEPROM : "));
